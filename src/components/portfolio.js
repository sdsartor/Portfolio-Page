                ...
                <div className="flip-card">
                    <div className="flip-card-inner">
                      ...
                      <div className="flip-card-back">
                        ...
                        <a href="https://pilot-application.netlify.app">https://pilot-application.netlify.app</a>
                      </div>
                    </div>
                  </div>
                  <div id="volley" class="flip-card">
                    <div className="flip-card-inner">
                      ...
                      <div className="flip-card-back">
                        ...
                        <p>Click Link Below</p>
                        <a href="https://captains-quarters.netlify.app">https://captains-quarters.netlify.app</a>
                      </div>
                    </div>
                  </div>
                  <div className="flip-card">
